    ...
    <div className="flex flex-col justify-center items-center gap-4 py-10">
      <section className="flex flex-col justify-between items-start w-[70%]">
        <div className="flex justify-center items-center gap-3">
          ...
          <h1 className="text-[22px] font-semibold text-gray-700 font-serif">
      ...
      >
        <div>
          <h1 className="text-gray-500 mb-1 font-semibold text-sm">Email:</h1>
          <input
            type="email"
            className="px-4 py-2 border border-gray-400 rounded-lg w-full focus:outline-gray-400"
            {...register("mail", {
        ...
        <button
          type="submit"
          className="bg-dark_blue text-white font-semibold w-full py-2 rounded-md cursor-pointer"
        >
          Login
        </button>
      </form>
      ...
      <section className="flex w-[70%] justify-center items-center gap-3">
        <div className="border-b-1 border-gray-500 w-20"></div>
